...
(function () {
  ...
  var createWizard = function (count) {
    ...
    for (var i = 0; i <= count - 1; i++) {
      var wizardName = window.setup.getRandomValue(WIZARD_NAMES);
      var wizardSurname = window.setup.getRandomValue(WIZARD_SURNAMES);
      var wizardCoat = window.setup.getRandomValue(COAT_COLOR);
      var wizardEyes = window.setup.getRandomValue(EYES_COLOR);
